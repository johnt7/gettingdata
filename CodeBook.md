...
## Attribution.
The information in this document is based on "features_info.txt" from the data found at: <https://d396qusza40orc.cloudfront.net/getdata%2Fprojectfiles%2FUCI%20HAR%20Dataset.zip>.
...
But in this case only 2 are used:
